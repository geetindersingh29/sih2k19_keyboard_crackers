...
public class SignupActivity extends AppCompatActivity {
    ...
    private EditText inputEmail, inputPassword, city,state;     //hit option + enter if you on mac , for windows hit ctrl + enter
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    rootRef.child(id).child("name").setValue(mname);
                                    rootRef.child(id).child("uid").setValue(uID);
                                    rootRef.child(id).child("email").setValue(email);
                                    ...
                                    rootRef.child(id).child("seller_rating_total").setValue(0);
                                    rootRef.child(id).child("date joined").setValue(date.toString());
    ...
    public void regst(View view)
    {
        Intent obj1=new Intent(this,LoginActivity.class);
        startActivity(obj1);
    }
}
